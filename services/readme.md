...
The simplemap can be opened in GitHub Pages by modifying the url `https://geolaurajaimes.github.io/geom99lab1/services/simplemap.html`. Remember to replace the `[username]` portion with your actual GitHub username. 
